    ...
    const products = [
        {
            id: 1,
            title: "Modern Sofa",
            desc: "Comfortable and stylish sofa for your living room with a refined modern look.",
            img: ModernSofa,
            tag: "Living Room",
        },
        {
        ...
        },
        {
            id: 3,
            title: "Luxury Bed",
            desc: "Beautiful bed design for a modern bedroom with comfort, style, and durability.",
            img: LuxuryBed,
            tag: "Bedroom Essential",
        },
    ];
