        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-2">
          <div>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <button className="rounded-2xl bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-200 transition hover:-translate-y-0.5 hover:bg-blue-700">
                Explore Products
              </button>
              <button className="rounded-2xl border border-gray-300 bg-white px-6 py-3 text-sm font-semibold text-gray-700 transition hover:border-blue-300 hover:text-blue-600">
                Contact Sales
              </button>
            </div>
      ...
      <section className="px-6 pb-14 md:px-10 lg:px-16">
        <div className="mx-auto max-w-7xl rounded-[32px] bg-gradient-to-r from-gray-900 via-slate-900 to-blue-900 p-8 text-white shadow-2xl md:p-12">
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            ...
            <button className="rounded-2xl bg-white px-6 py-3 text-sm font-bold text-gray-900 transition hover:bg-blue-50">
              Contact Now
            </button>
          </div>
        </div>
